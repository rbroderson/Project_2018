...
SELECT * INTO ADMISSIONS2 FROM ADMISSIONS 


DELETE FROM ADMISSIONS WHERE ROW_ID NOT IN(
SELECT A.ROW_ID FROM ADMISSIONS2 A INNER JOIN PATIENTS P ON P.SUBJECT_ID = A.SUBJECT_ID WHERE  A.ADMITTIME BETWEEN DATEADD(d, -2000, P.INDEX_DATE) AND P.INDEX_DATE) 
...
SELECT TOP 1 * FROM PROCEDURES_ICD
SELECT TOP 1 * FROM LABEVENTS  --CHARTIME
SELECT TOP 1 * FROM PRESCRIPTIONS
SELECT TOP 1 * FROM PROCEDURES_ICD
SELECT TOP 1 * FROM ADMISSIONS
SELECT TOP 1 * FROM CHARTEVENTS
SELECT TOP 1 * FROM 
