...
case class Prescription(patientID: String, drug: String, DOSE_VAL_RX: String, value: Double)

//case class Diagnoses(patientID: String, date: Date, code: String)

case class Procedures(patientID: String, code: String, count: Int)

case class Patient(patientID: String, age: Int, gender: String, genderIndicator: Int, dob: String, dod: String, expireFlag: Int)
